...
PROTECTED_LINUX_CATALOG_ASSETS = {
    "linux-i386": {
        "remote-ops-workspace-v1.0.11-linux-i386.deb",
        "remote-ops-workspace-v1.0.11-linux-i686.rpm",
        "remote-ops-workspace-v1.0.11-linux-i686.AppImage",
        "remote-ops-workspace-v1.0.11-linux-i686-native.tar.gz",
        "remote-ops-workspace-v1.0.11-linux-i686-native-manifest.json",
        "remote-ops-workspace-v1.0.11-linux-i686-native-SHA256SUMS.txt",
    },
    "linux-armhf": {
        "remote-ops-workspace-v1.0.11-linux-armhf.deb",
        "remote-ops-workspace-v1.0.11-linux-armv7hl.rpm",
        "remote-ops-workspace-v1.0.11-linux-armhf.AppImage",
        "remote-ops-workspace-v1.0.11-linux-armhf-native.tar.gz",
        "remote-ops-workspace-v1.0.11-linux-armhf-native-manifest.json",
        "remote-ops-workspace-v1.0.11-linux-armhf-native-SHA256SUMS.txt",
    },
}
