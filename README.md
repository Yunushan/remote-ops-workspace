...
![release](https://img.shields.io/badge/release-v1.0.24-blue)
...
controls and the six product-style layouts. The uploaded interaction manifest
also contains 20-sample p50, p95 and maximum latency evidence for the Qt event
loop, terminal-tab transitions, a 128-profile tree filter and incremental
terminal rendering. CI rejects a p95 above 100 ms for an idle event-loop turn,
250 ms for tab switching or profile filtering, and 400 ms for terminal append;
separate maximum budgets catch isolated freezes, and terminal append must keep
the live viewport anchored at the bottom.
...
with an immutable tag input such as `v1.0.24`; it builds that tag and uploads
...
| Target | Asset |
|---|---|
| Python wheel | `remote_ops_workspace-1.0.24-py3-none-any.whl` |
| Python sdist | `remote_ops_workspace-1.0.24.tar.gz` |
| Source/Python SBOM | `remote-ops-workspace-v1.0.24-sbom.cdx.json` |
| Source | `remote-ops-workspace-v1.0.24-source.zip` |
| Windows | `remote-ops-workspace-v1.0.24-windows.zip` |
| Linux | `remote-ops-workspace-v1.0.24-linux.tar.gz` |
| macOS | `remote-ops-workspace-v1.0.24-macos.tar.gz` |
| BSD | `remote-ops-workspace-v1.0.24-bsd.tar.gz` |
| Solaris/illumos | `remote-ops-workspace-v1.0.24-solaris.tar.gz` |
| Android/Termux | `remote-ops-workspace-v1.0.24-android-termux.tar.gz` |
| iOS/iPadOS Web/PWA | `remote-ops-workspace-v1.0.24-web-pwa.zip` |
| Web/PWA | `remote-ops-workspace-v1.0.24-web-pwa.zip` |
| Windows native | `remote-ops-workspace-v1.0.24-windows-<x86\|x64\|arm64>-setup.exe` |
| Windows native | `remote-ops-workspace-v1.0.24-windows-<x86\|x64\|arm64>.msi` |
| Windows native | `remote-ops-workspace-v1.0.24-windows-<x86\|x64\|arm64>-native.zip` |
| macOS native | `remote-ops-workspace-v1.0.24-macos-<x64\|arm64>.dmg` |
| macOS native | `remote-ops-workspace-v1.0.24-macos-<x64\|arm64>.pkg` |
| macOS native | `remote-ops-workspace-v1.0.24-macos-<x64\|arm64>-native-manifest.json` |
| Linux native | `remote-ops-workspace-v1.0.24-linux-<amd64\|arm64>.deb` |
| Linux native | `remote-ops-workspace-v1.0.24-linux-<x86_64\|aarch64>.rpm` |
| Linux native | `remote-ops-workspace-v1.0.24-linux-<x86_64\|aarch64>.AppImage` |
| Linux native | `remote-ops-workspace-v1.0.24-linux-<x86_64\|aarch64>-native.tar.gz` |
| Linux native | `remote-ops-workspace-v1.0.24-linux-<x86_64\|aarch64>-native-manifest.json` |
| Manifests | `remote-ops-workspace-v1.0.24-*-manifest.json` |
| Checksums | `remote-ops-workspace-v1.0.24-SHA256SUMS.txt` |
