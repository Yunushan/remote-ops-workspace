...
The GitHub release workflow runs on tags like `v1.0.1` and uploads these assets:

| Target | Asset |
|---|---|
| Python wheel | `remote_ops_workspace-1.0.1-py3-none-any.whl` |
| Python sdist | `remote_ops_workspace-1.0.1.tar.gz` |
| Source | `remote-ops-workspace-v1.0.1-source.zip` |
| Windows | `remote-ops-workspace-v1.0.1-windows.zip` |
| Linux | `remote-ops-workspace-v1.0.1-linux.tar.gz` |
| macOS | `remote-ops-workspace-v1.0.1-macos.tar.gz` |
| BSD | `remote-ops-workspace-v1.0.1-bsd.tar.gz` |
| Solaris/illumos | `remote-ops-workspace-v1.0.1-solaris.tar.gz` |
| Android/Termux | `remote-ops-workspace-v1.0.1-android-termux.tar.gz` |
| Web/PWA | `remote-ops-workspace-v1.0.1-web-pwa.zip` |
| Windows native | `remote-ops-workspace-v1.0.1-windows-<x86\|x64\|arm64>-setup.exe` |
| Windows native | `remote-ops-workspace-v1.0.1-windows-<x86\|x64\|arm64>.msi` |
| Windows native | `remote-ops-workspace-v1.0.1-windows-<x86\|x64\|arm64>-native.zip` |
| macOS native | `remote-ops-workspace-v1.0.1-macos-<x64\|arm64>.dmg` |
| macOS native | `remote-ops-workspace-v1.0.1-macos-<x64\|arm64>.pkg` |
| macOS native | `remote-ops-workspace-v1.0.1-macos-<x64\|arm64>-native-manifest.json` |
| Linux native | `remote-ops-workspace-v1.0.1-linux-<amd64\|arm64>.deb` |
| Linux native | `remote-ops-workspace-v1.0.1-linux-<x86_64\|aarch64>.rpm` |
| Linux native | `remote-ops-workspace-v1.0.1-linux-<x86_64\|aarch64>.AppImage` |
| Linux native | `remote-ops-workspace-v1.0.1-linux-<x86_64\|aarch64>-native.tar.gz` |
| Linux native | `remote-ops-workspace-v1.0.1-linux-<x86_64\|aarch64>-native-manifest.json` |
| Manifests | `remote-ops-workspace-v1.0.1-*-manifest.json` |
| Checksums | `remote-ops-workspace-v1.0.1-SHA256SUMS.txt` |
