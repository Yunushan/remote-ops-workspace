...
![release](https://img.shields.io/badge/release-v1.0.25-blue)
...
with an immutable tag input such as `v1.0.25`; it builds that tag and uploads
...
| Target | Asset |
|---|---|
| Python wheel | `remote_ops_workspace-1.0.25-py3-none-any.whl` |
| Python sdist | `remote_ops_workspace-1.0.25.tar.gz` |
| Source/Python SBOM | `remote-ops-workspace-v1.0.25-sbom.cdx.json` |
| Source | `remote-ops-workspace-v1.0.25-source.zip` |
| Windows | `remote-ops-workspace-v1.0.25-windows.zip` |
| Linux | `remote-ops-workspace-v1.0.25-linux.tar.gz` |
| macOS | `remote-ops-workspace-v1.0.25-macos.tar.gz` |
| BSD | `remote-ops-workspace-v1.0.25-bsd.tar.gz` |
| Solaris/illumos | `remote-ops-workspace-v1.0.25-solaris.tar.gz` |
| Android/Termux | `remote-ops-workspace-v1.0.25-android-termux.tar.gz` |
| iOS/iPadOS Web/PWA | `remote-ops-workspace-v1.0.25-web-pwa.zip` |
| Web/PWA | `remote-ops-workspace-v1.0.25-web-pwa.zip` |
| Windows native | `remote-ops-workspace-v1.0.25-windows-<x86\|x64\|arm64>-setup.exe` |
| Windows native | `remote-ops-workspace-v1.0.25-windows-<x86\|x64\|arm64>.msi` |
| Windows native | `remote-ops-workspace-v1.0.25-windows-<x86\|x64\|arm64>-native.zip` |
| macOS native | `remote-ops-workspace-v1.0.25-macos-<x64\|arm64>.dmg` |
| macOS native | `remote-ops-workspace-v1.0.25-macos-<x64\|arm64>.pkg` |
| macOS native | `remote-ops-workspace-v1.0.25-macos-<x64\|arm64>-native-manifest.json` |
| Linux native | `remote-ops-workspace-v1.0.25-linux-<amd64\|arm64>.deb` |
| Linux native | `remote-ops-workspace-v1.0.25-linux-<x86_64\|aarch64>.rpm` |
| Linux native | `remote-ops-workspace-v1.0.25-linux-<x86_64\|aarch64>.AppImage` |
| Linux native | `remote-ops-workspace-v1.0.25-linux-<x86_64\|aarch64>-native.tar.gz` |
| Linux native | `remote-ops-workspace-v1.0.25-linux-<x86_64\|aarch64>-native-manifest.json` |
| Manifests | `remote-ops-workspace-v1.0.25-*-manifest.json` |
| Checksums | `remote-ops-workspace-v1.0.25-SHA256SUMS.txt` |
