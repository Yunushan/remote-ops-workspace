...
- Release tags must match `pyproject.toml` exactly, for example `v1.0.6`.
...
- Python wheel, Python sdist, target source/install bundles, the release
  manifest and `remote-ops-workspace-v1.0.6-SHA256SUMS.txt`;
...
- `remote_ops_workspace-1.0.6-py3-none-any.whl`
- `remote_ops_workspace-1.0.6.tar.gz`
- target source/install bundles for Windows, Linux, macOS, BSD, Solaris,
  Android/Termux, and Web/PWA
- `remote-ops-workspace-v1.0.6-release-manifest.json`
- `remote-ops-workspace-v1.0.6-SHA256SUMS.txt`
...
- `remote-ops-workspace-v1.0.6-windows-<x86|x64|arm64>-setup.exe`
- `remote-ops-workspace-v1.0.6-windows-<x86|x64|arm64>.msi`
- `remote-ops-workspace-v1.0.6-windows-<x86|x64|arm64>-native.zip`
- `remote-ops-workspace-v1.0.6-windows-<x86|x64|arm64>-native-manifest.json`
- `remote-ops-workspace-v1.0.6-windows-<x86|x64|arm64>-native-SHA256SUMS.txt`
...
- `remote-ops-workspace-v1.0.6-macos-<x64|arm64>-native-manifest.json`
- `remote-ops-workspace-v1.0.6-macos-<x64|arm64>-native-SHA256SUMS.txt`
...
- `remote-ops-workspace-v1.0.6-linux-<x86_64|aarch64>-native-manifest.json`
- `remote-ops-workspace-v1.0.6-linux-<x86_64|aarch64>-native-SHA256SUMS.txt`
