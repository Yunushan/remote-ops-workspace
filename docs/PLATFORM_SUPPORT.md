...
| Python sdist | `remote_ops_workspace-1.0.8.tar.gz` |
| Source | `remote-ops-workspace-v1.0.8-source.zip` |
| Windows | `remote-ops-workspace-v1.0.8-windows.zip` |
| Linux | `remote-ops-workspace-v1.0.8-linux.tar.gz` |
| macOS | `remote-ops-workspace-v1.0.8-macos.tar.gz` |
| BSD | `remote-ops-workspace-v1.0.8-bsd.tar.gz` |
| Solaris/illumos | `remote-ops-workspace-v1.0.8-solaris.tar.gz` |
| Android/Termux | `remote-ops-workspace-v1.0.8-android-termux.tar.gz` |
| iOS/iPadOS Web/PWA | `remote-ops-workspace-v1.0.8-web-pwa.zip` |
| Web/PWA | `remote-ops-workspace-v1.0.8-web-pwa.zip` |
| Windows native | `remote-ops-workspace-v1.0.8-windows-<x86\|x64\|arm64>-setup.exe` |
| Windows native | `remote-ops-workspace-v1.0.8-windows-<x86\|x64\|arm64>.msi` |
| Windows native | `remote-ops-workspace-v1.0.8-windows-<x86\|x64\|arm64>-native.zip` |
| macOS native | `remote-ops-workspace-v1.0.8-macos-<x64\|arm64>.dmg` |
| macOS native | `remote-ops-workspace-v1.0.8-macos-<x64\|arm64>.pkg` |
| macOS native | `remote-ops-workspace-v1.0.8-macos-<x64\|arm64>-native-manifest.json` |
| Linux native | `remote-ops-workspace-v1.0.8-linux-<amd64\|arm64>.deb` |
| Linux native | `remote-ops-workspace-v1.0.8-linux-<x86_64\|aarch64>.rpm` |
| Linux native | `remote-ops-workspace-v1.0.8-linux-<x86_64\|aarch64>.AppImage` |
| Linux native | `remote-ops-workspace-v1.0.8-linux-<x86_64\|aarch64>-native.tar.gz` |
| Linux native | `remote-ops-workspace-v1.0.8-linux-<x86_64\|aarch64>-native-manifest.json` |
| Manifests | `remote-ops-workspace-v1.0.8-*-manifest.json` |
...
- Static Web/PWA asset from `remote-ops-workspace-v1.0.8-web-pwa.zip`.
