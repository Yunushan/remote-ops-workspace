...
record a recovery exercise in an isolated environment: restore a recent encrypted
...
job without a successful recovery exercise is not production recovery evidence.
