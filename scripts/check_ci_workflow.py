...
def check_coverage_job(workflow: str) -> list[str]:
    ...
    elif float(threshold_match.group(1)) < 77.5:
        errors.append("ci coverage job aggregate coverage failure threshold must be at least 77.5")
    ...
    elif float(total_match.group(1)) < 77.5:
        errors.append("ci coverage job validated aggregate coverage threshold must be at least 77.5")
    ...
    elif float(branch_match.group(1)) < 62.5:
        errors.append("ci coverage job pure branch coverage threshold must be at least 62.5")
