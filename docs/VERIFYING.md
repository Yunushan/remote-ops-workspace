...
- XP evidence JSON and accepted platform records must use a concrete artifact validation `--assets-dir`; placeholders such as `<artifact-dir>` are rejected outside documentation examples;
