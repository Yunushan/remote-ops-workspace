...
- `python scripts/check_gui_visual_metrics.py` for stdlib PNG sampling of static preview layout regions, brightness bands, nonblank visual complexity, product-style color anchors, structural line anchors and named-region topology contracts across all selectable presets;
