...
with an immutable tag input such as `v1.0.18`; it builds that tag and uploads
...
| Source/Python SBOM | `remote-ops-workspace-v1.0.18-sbom.cdx.json` |
...
| Checksums | `remote-ops-workspace-v1.0.18-SHA256SUMS.txt` |
