...
STALE_DEFAULT_ARTIFACT_SNIPPETS = (
    "remote-ops-workspace-v1.0.14-linux-<i386|amd64|armhf|arm64>.deb",
    "remote-ops-workspace-v1.0.14-linux-<i686|x86_64|armv7hl|aarch64>.rpm",
    "remote-ops-workspace-v1.0.14-linux-<i686|x86_64|armhf|aarch64>.AppImage",
    "remote-ops-workspace-v1.0.14-linux-<i686|x86_64|armhf|aarch64>-native.tar.gz",
    "remote-ops-workspace-v1.0.14-macos-<arch>.dmg",
    "remote-ops-workspace-v1.0.14-macos-<arch>.pkg",
)
...
def contains_exact_release_version_snippet(text: str, snippet: str) -> bool:
    """Match a stale release token without treating v1.0.14 as v1.0.1."""
