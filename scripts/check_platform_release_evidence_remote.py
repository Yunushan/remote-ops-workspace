...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--release-tag", required=True, help="release tag, for example v1.0.14")
    ...
    parser.add_argument(
        ...
        help=(
            ...
            "https://github.com/owner/repo/releases/download/v1.0.14/platform-verified-evidence-linux-i386-final.json=record.json"
        ),
    )
    parser.add_argument(
        "--release-asset",
        ...
        help=(
            ...
            "offline byte verification, for example "
            "https://github.com/owner/repo/releases/download/v1.0.14/remote-ops-workspace-v1.0.14-linux-i386.deb=asset.deb"
        ),
    )
    parser.add_argument(
        "--tag-ref-json",
